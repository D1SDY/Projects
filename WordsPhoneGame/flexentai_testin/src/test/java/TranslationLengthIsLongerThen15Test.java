...
public class TranslationLengthIsLongerThen15Test {
    ...
    @Test
    public void wordLengthIsLongerThen15Test() {
        ...
        driver.findElement(By.id("newWordTranslation")).sendKeys("qwertyuiopasdfgh");
