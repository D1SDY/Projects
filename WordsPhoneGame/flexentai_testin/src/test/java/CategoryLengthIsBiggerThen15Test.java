...
public class CategoryLengthIsBiggerThen15Test {
    ...
    @Test
    public void categoryLengthIsBiggerThen15Test() {
        ...
        driver.findElement(By.id("addCategory")).sendKeys("qwertyuiopasdfgh");
        driver.findElement(By.id("addCategoryToWords")).click();
        WebElement ele=driver.findElement(By.xpath("/html/body/div[2]/div[2]/div/p"));
